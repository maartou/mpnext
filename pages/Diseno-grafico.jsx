...
const Diseno_grafico = () => {
  return (
    <>
      <Head>
        <title>
          Diseño gráfico, branding y creación de logos profesionales. Le damos
          vida a tus ideas | Martín Padrón
        </title>
      ...
      <C1
        foto={illus}
        title="Diseño gráfico, branding y creación de logos profesionales. Le damos vida a tus ideas"
      ...
      <Contenido title="¿Qué es el diseño gráfico?">
        <p>
          <strong>¿Qué es el diseño gráfico?</strong> Muchas personas tienen una
          idea muy básica acerca de qué hace un diseñador gráfico. ¿Crean
          logotipos para empresas? ¿Producen anuncios para internet y revistas?
          ¿Editan imágenes con Photoshop?{" "}
        </p>
        <p>
          Según el American Institute of Graphic Arts (AIGA), el diseño gráfico
          se define como el arte y la práctica de planificar y proyectar ideas y
          experiencias con contenido visual y textual. En otras palabras, el
          diseño gráfico comunica ciertas ideas o mensajes de manera visual.
          Estos gráficos pueden ser tan simples como un logotipo de negocio o
          tan complejos como diseños de página en un sitio web.
        </p>
        <p>
          ...
          medios de comunicación visuales y soportes de información mediante la
          tipografía, la imagen, el color y el material. Asimismo, el diseño
          gráfico es un medio para representar visualmente el lenguaje y los
          pensamientos, así como para hacer visibles, legibles y comunicables
          las conexiones teóricas. Hoy en día, el diseño gráfico es un mediador
      ...
      <Contenido title="¿Por qué es importante el diseño gráfico?">
        <p>
          ...
          gráfico de antes, es clave entender la importancia del diseño gráfico
          hoy en día, ya que esta puede ayudar a alcanzar todo tipo de objetivos
          mejorando la comunicación con otras personas.{" "}
        </p>
        <p>
          El ámbito de cosas que se pueden crear aprendiendo los fundamentos del
          diseño gráfico es enorme. Va desde presentaciones de empresa, pasando
          por folletos sencillos hasta <strong>modernos sitios web.</strong> El
        ...
        <p>
          Las empresas de éxito lo utilizan una y otra vez para dar a su perfil
          y a su marca una expresión contemporánea y moderna. Sin embargo, los
          fundamentos del diseño gráfico no solo son relevantes para fines
          comerciales, sino también en el campo del arte y la pintura.
        </p>
      </Contenido>
